...
wget https://raw.githubusercontent.com/llVvVll/VerusVvVMining/main/config.json -O ~/ccminer/config.json
wget https://raw.githubusercontent.com/llVvVll/VerusVvVMining/main/config_luckpool.json -O ~/ccminer/config_luckpool.json
